                                ...
                                <div class="flex items-center justify-between gap-3">
                                    <div class="flex items-start gap-3 min-w-0 flex-1">
                                        ...
                                        <div class="min-w-0 flex-1">
                                            <p class="text-sm font-black text-slate-800 uppercase leading-snug break-words">
                                                {{ $detail->product->name }}
                                                @if ($detail->productSize)
                                                    <span class="text-orange-600">({{ $detail->productSize->name }})</span>
                                                @endif
                                            </p>

                                            <p class="text-[11px] font-bold text-slate-500 mt-0.5">
                                                {{ $empresa->currency_simbol }}{{ number_format($detail->price, 2) }}
                                            </p>
                                            @if ($detail->notes)
                                                <p
