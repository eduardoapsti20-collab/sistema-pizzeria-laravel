...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/cash-registers/{id}/close', [CashRegisterController::class, 'close'])->name('boxes.close')->middleware('can:cajas.cerrar');
    ...
    Route::get('/orders/chef', [OrderController::class, 'chef'])->name('orders.chef')->middleware('can:ordenes.ver');
